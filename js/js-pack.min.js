 ...
 * VERSION: beta 0.9
 * DATE: 2013-03-10  
 * Includes all of the following: HTML5 Shiv v3.6.2, jQuery v1.10.2, TweenMax 1.20.4, ,jQuery-GSAP-plugin 0.1.12, jQuery Mouse Wheel Plug-in 3.1.1,bxSlider v4.2.13
 * @license : MIT & BSD
 **/

;(function(e){e.documentElement.className=e.documentElement.className.replace("no-js","js")})(this.document)
